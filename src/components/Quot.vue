<template>
    <div class="container mt-5 box">
        <h1 class="title is-2">Quotation closing mail</h1>
        ...
        <label for="caseid" class="label">Case id</label>
        <input class="input is-primary" type="text" id="caseid" v-model="caseid">
